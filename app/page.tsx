...
export default function Home() {
  ...
  function handleExcelSelection(event:ChangeEvent<HTMLInputElement>|FormEvent<HTMLInputElement>){
    ...
    if(!file){setExcelFileActivity(null);return;}
